...
# 定义函数
def text_style_transformation(text, store_name):
    # 初始化ChatOpenAI
    ...
    db = FAISS.load_local(store_path, embed_model, allow_dangerous_deserialization=True)
...
store_name = "shashibiya"
style_output = text_style_transformation(text, store_name)
print(style_output)
